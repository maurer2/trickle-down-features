...
| `align-content` | Block elements and table elements | Parent | Align child elements on the block-axis. Alternative to `vertical-align` in table-headers and table | [Block elements](https://caniuse.com/mdn-css_properties_align-content_block_context) <br/><br/> Table elements | [Link](https://maurer2.github.io/trickle-down-features/#/align-content)|
